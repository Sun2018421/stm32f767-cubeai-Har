...
#ifndef __AI_HARGITHUB_H__
#define __AI_HARGITHUB_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_HARGITHUB_MODEL_NAME          "hargithub"

#define AI_HARGITHUB_IN_NUM       (1)
#define AI_HARGITHUB_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 90, 3, 1, 1, NULL), \
}
#define AI_HARGITHUB_IN_SIZE { \
  (90 * 3 * 1), \
}
#define AI_HARGITHUB_IN_1_SIZE  (90 * 3 * 1)
#define AI_HARGITHUB_IN_1_SIZE_BYTES  ((90 * 3 * 1) * 4)




#define AI_HARGITHUB_OUT_NUM      (1)
#define AI_HARGITHUB_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 6, 1, NULL), \
}
#define AI_HARGITHUB_OUT_SIZE { \
  (1 * 1 * 6), \
}
#define AI_HARGITHUB_OUT_1_SIZE  (1 * 1 * 6)
#define AI_HARGITHUB_OUT_1_SIZE_BYTES  ((1 * 1 * 6) * 4)

#define AI_HARGITHUB_N_NODES (7)
 ...
 * @ref ai_hargithub_create. Both the activations memory buffer 
 ...
 * using @ref ai_hargithub_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_HARGITHUB_*
 * defines into file @ref hargithub.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_hargithub_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_HARGITHUB_H__*/
